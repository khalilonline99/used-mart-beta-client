...
const Testimonials = () => {
    return (
        <div className='mt'>
            <h2 className='font-bold text-2xl text-center'>Client Review</h2>
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex lg:flex-nowrap flex-wrap mx-2">
                        <div className="lg:w-1/3 lg:mb-0 p-2 rounded-xl shadow-xl mx-2">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-2 rounded-xl shadow-xl">
                            <div className="h-full text-center">
